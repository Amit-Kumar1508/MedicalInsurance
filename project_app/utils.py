...
class MedicalInsurance():
    ...
    def load_model(self):
        with open(r'F:\Velocity DataScience\Flask Practice\Flask_01\medical_insurance\project_app\Linear_model.pkl','rb') as f:
            self.model = pickle.load(f)

        with open(r'F:\Velocity DataScience\Flask Practice\Flask_01\medical_insurance\project_app\project_data.json','r') as f:
